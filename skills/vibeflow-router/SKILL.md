...
返回：`increment`、`think`、`template-selection`、`plan-review`、`requirements`、`ucd`、`design`、`build-init`、`build-config`、`build-work`、`review`、`test-system`、`test-qa`、`ship`、`reflect`、`done`
...
| `plan-review` | `skills/vibeflow-plan-review/SKILL.md` | 批准的 workflow |
...
### 阶段：`plan-review`
**条件**：模板已选定，需审查批准。
**操作**：使用 `skills/vibeflow-plan-review/SKILL.md`，用户批准后更新 `phase-history.json`。
