...
description: |
  ...
  Use when asked to "review the architecture", "engineering review",
  "lock in the plan", or when a plan is ready for technical scrutiny.
  Proactively suggest when the user has a plan or design doc and is about to
  start coding — to catch architecture issues before implementation.
benefits-from: [vibeflow-office-hours]
allowed-tools:
  - Read
  - Write
  - Grep
