...
VibeFlow 是一个AI 工程交付编排框架。大模型擅长即兴，软件工程需要定力。真正稀缺的不是“生成一段代码”，而是把一个想法稳稳穿过需求、设计、实现、审查、测试、发布与复盘，直到它变成一个可以交付、可以追溯、可以继续演化的系统。VibeFlow 做的，就是给这条路铺上轨道，让 AI 少一点碰运气，多一点章法、记忆与收尾。
...
---
<img width="2528" height="1684" alt="compare" src="https://github.com/user-attachments/assets/9a3be1a9-270c-46fc-b303-67b451ed860f" />
...
<img width="1376" height="768" alt="image" src="https://github.com/user-attachments/assets/fefa6459-f23a-4b7e-8382-e1457f1b7d62" />
...
<img width="2528" height="1684" alt="7 stage" src="https://github.com/user-attachments/assets/410e78e6-70c5-4e72-99e6-0855e6c889eb" />
...
`Quick Mode` 会压缩前置分析，但不会跳过 Review 和 Test。  
`Full Mode` 适合默认的大多数正式开发场景。
