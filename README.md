...
| 步骤 | 内容 | 产出 |
|------|------|------|
| 初始化 | 创建脚手架文件 | `feature-list.json`、`.vibeflow/logs/session-log.md`、`.vibeflow/work-config.json` |
...
| `design-review.md` | Design 阶段产物：工程评审 + 设计评审结论 |
| `verification/review.md` | 全局代码审查报告 |
| `verification/qa.md` | QA 测试报告 |
...
| `docs/changes/<change-id>/design.md` | 技术设计文档（含 UCD 相关内容）|
...
| `.vibeflow/logs/session-log.md` | 任务进度日志 |
